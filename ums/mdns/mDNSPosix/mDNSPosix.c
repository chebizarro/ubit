...
Revision ubit-version-1  2004/06/15  elc
look for #ubit for changes
...
mDNSexport mStatus mDNSPlatformSendUDP(const mDNS *const m, const DNSMessage *const msg, const mDNSu8 *const end,
	...
	err = sendto(thisIntf->multicastSocket, msg, (char*)end - (char*)msg, 0, (struct sockaddr *)&to, GET_SA_LEN(*(struct sockaddr *)&to));
	  ...
	  */
	  err = sendto(thisIntf->multicastSocketv6, msg, (char*)end - (char*)msg, 0, (struct sockaddr *)&to, GET_SA_LEN(*(struct sockaddr *)&to));
#endif
